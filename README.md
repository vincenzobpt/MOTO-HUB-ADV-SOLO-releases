...
<img src="media/logo-adv-solo.png" alt="MOTO-HUB ADV-SOLO logo" width="120">

# MOTO-HUB ADV-SOLO

**The riding app for every motorcyclist, on any motorcycle. Free, forever.**<br>
...
<img src="media/phone-nav.gif" alt="The Nav home: search, a map with Home and Work, a Ride again card and doors for Places, Rides, Plan and Loop" width="260" align="right">
...
<div align="center">
  ...
  <br>
  <sub>Live data &middot; fuel and air &middot; full scan. The OBD page, one tap from the Ride tab.</sub>
</div>
...
<img src="media/phone-mode.gif" alt="The mode page: a real-size picture of the TFT, a Start button, the modes on a rail and the Dashboard map sources" width="260" align="right">
...
<img src="media/obd-horizon.gif" alt="Horizon OBD dashboard: scrolling speed and rev tapes, a big gear number, throttle and load bars and a status strip" width="100%"><br>
...
<td width="50%" valign="top">
<img src="media/obd-thermal.gif" alt="Thermal OBD dashboard: big speed, a gear ring that heats with revs, a glowing coolant dial and 60 seconds of rev, throttle and load history" width="100%"><br>
...
<tr>
<td width="50%" valign="top">
<img src="media/obd-signal.gif" alt="Signal OBD dashboard: rev bricks across the top, a yellow gear plate, speed in black on white and a coolant block that changes colour with state" width="100%"><br>
...
<td width="50%" valign="top">
<img src="https://raw.githubusercontent.com/vincenzobpt/MOTO-HUB/main/media/tft-obd-dashboard.png" alt="The Classic OBD gauge cluster in the Ride Dashboard main panel" width="100%"><br>
...
<img src="media/phone-about.gif" alt="The About page turning the key: the rev needle sweeps, the adventure bike lights up and the version rolls like an odometer" width="260" align="right">
